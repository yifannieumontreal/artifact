...
from inter_MACM_builder import GranuGateModel
from lib_tf.tf_utils import non_neg_normalize
from lib_tf.data_utils import list_shuffle, pad_batch_list
from lib_tf.eval import write_run, compute_ndcg, compute_map
from lib_tf.tf_utils import np_softmax, non_neg_normalize
        ...
        for epoch in range(1, n_epoch + 1):
            ...
            for f in train_files:
                ...
                if file_count % 4 == 0:
                    ...
                    model_name_str, d_len)  # pass the training compuational graph placeholder to valid function to evaluate with the same set of parameters
...
def validation(sess, placeholder_list, data_base_path, model_base_path,
               model_name_str, d_len, compute_ndcg_flag=True):
